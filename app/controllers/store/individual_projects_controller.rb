class Store::IndividualProjectsController < ApplicationController
  ...
  def individual_project_params
    params.require(:individual_projects).permit(:store_id, :last_name, :first_name, :last_name_kana, :first_name_kana, :collateral_id, :use_of_fund_id, :fund_type_id, :loan, :span, :month_payment, :last_mont_payment, :interest_rate, :joint_guarantor, :own_resource, :end_day, :date, :appoint_date, :is_active)
  end
end
